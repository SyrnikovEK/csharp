...
using FightClubPractice.UI;
using FightClubPractice.UI.AutorizationScene;
using FightClubPractice.UI.CombatScene;
using FightClubPractice.UI.MenuScene;
using FightClubPractice.UI.PlayerCreationScene;
using FightClubPractice.UI.RecordTableScene;
using FightClubPractice.UI.SecondPlayerLoadScene;
using System;
